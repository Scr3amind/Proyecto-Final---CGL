...
class CFiguras
{
	...
	void prisma (float altura, float largo, float profundidad, GLuint text, int rep=1);//Funcíon creacion prisma
	void prisma2 (GLuint text, GLuint text2);
	void skybox(float altura, float largo, float profundidad, GLuint text,float offset);	//Funcion creacion cielo
